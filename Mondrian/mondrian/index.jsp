...
analyze very large datasets stored in SQL databases without writing SQL.">
        ...
        <body>
            ...
            <ul>
                ...
                <li><a href="testpage.jsp?query=adw1">OLAP Data Warehouse ADW1</a></li>
                <li><a href="testpage.jsp?query=adw2">OLAP Data Warehouse ADW2</a></li>
                <li><a href="http://localhost:11006/browser" target="popup"
                        onclick="window.open('bolt://localhost:11006/browser','popup'); return false;">
                        Neo4j Browser - Sakila Graph Database
                    </a>
                </li>
            </ul> -->
            <p>UAS Adventure Works</p>
            <ul>
                <li><a href="testpage.jsp?query=Measure1">Adventure Works Sales</a></li>
            </ul>
        </body>
